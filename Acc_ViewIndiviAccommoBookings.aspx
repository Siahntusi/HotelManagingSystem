<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Acc_ViewIndiviAccommoBookings.aspx.cs" Inherits="AAFS.Acc_ViewIndiviAccommoBookings" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content" class="padding50">
        ...
        <div id="wrapper">
            ...
            <div id="AccommoStudBookingsDiv" runat="server" class="  table table-responsive" style="width: 100%">
            </div>
